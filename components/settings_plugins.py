...
class PluginsSettingsWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        # Community Plugins Table (placeholder for now)
        self.community_plugins_table = QTableWidget()
        self.community_plugins_table.setColumnCount(3)
        self.community_plugins_table.setHorizontalHeaderLabels(["Enabled", "Plugin", "Location"])
        ...
        # Add placeholder message for community plugins
        community_placeholder = QLabel("Community plugins will be available here.\nBrowse and install plugins from the community repository.")
        community_placeholder.setStyleSheet("""
            color: #888;
            font-size: 14px;
            text-align: center;
            padding: 40px;
        """)
        community_placeholder.setAlignment(Qt.AlignmentFlag.AlignCenter)
        community_layout.addWidget(community_placeholder)
